...
import com.sultanAyubi.videoPlayer.databinding.ActivityMainBinding
import com.sultanAyubi.videoPlayer.databinding.ThemeViewBinding
            ...
            when (it.itemId) {
                ...
                R.id.sortOrderNav -> {
                    ...
                    dialog.getButton(android.app.AlertDialog.BUTTON_POSITIVE).setBackgroundColor(
                        MaterialColors.getColor(this, R.attr.themeColor, Color.RED)
                    )
                }
